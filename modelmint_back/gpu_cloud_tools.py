...
@mcp.tool()
def list_gpu_instances(provider_name: str, api_key: str) -> List[Dict[str, Any]]:
    """
...
def get_instance_details(
    provider_name: str, api_key: str, instance_id: str
) -> Dict[str, Any]:
    """
...
@mcp.tool()
def terminate_gpu_instance(provider_name: str, api_key: str, instance_id: str) -> bool:
    """
...
@mcp.tool()
def list_ssh_keys(provider_name: str, api_key: str) -> List[Dict[str, Any]]:
    """
...
@mcp.tool()
def add_ssh_key(
    provider_name: str, api_key: str, name: str, public_key: str
) -> Dict[str, Any]:
    """
...
@mcp.tool()
def delete_ssh_key(provider_name: str, api_key: str, key_id: str) -> bool:
    """
